% Figure 11: lambda_plus の比較分析
% figure7.m を整理・拡張: 2ケースを構造体で管理して描画
...
%% プロット
title_suffix = '';
plot_lambda_plus(cases, results, xi, xi_min, xi_max, params, title_suffix);
...
function plot_lambda_plus(cases, results, xi, xi_min, xi_max, params, ~)
  styles = {'-', '--', '-.', ':'};
